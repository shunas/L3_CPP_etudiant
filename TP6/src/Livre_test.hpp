...
TEST(TestGroup, Livre_constructeur_1) 
{
...
TEST(TestGroup, Livre_constructeur_2) 
{
	try 
    {
        Livre livre("titre1;", "auteur1", 1337);
...
TEST(TestGroup, Livre_constructeur_3) 
{
	try 
    {
        Livre livre("titre1", "auteur1;", 1337);
...
TEST(TestGroup, Livre_constructeur_4) 
{
	try 
    {
...
TEST(TestGroup, Livre_inferieur_pp) 
{
...
TEST(TestGroup, Livre_inferieur_pz) 
{
...
TEST(TestGroup, Livre_inferieur_pm) 
{
...
TEST(TestGroup, Livre_inferieur_zp) 
{
...
TEST(TestGroup, Livre_inferieur_zz) 
{
...
TEST(TestGroup, Livre_inferieur_zm) 
{
...
TEST(TestGroup, Livre_inferieur_mp) 
{
...
TEST(TestGroup, Livre_inferieur_mz) 
{
...
TEST(TestGroup, Livre_inferieur_mm) 
{
...
TEST(TestGroup, Livre_egalite_1) 
{
	CHECK_EQUAL(Livre("t1","a1",1)==Livre("t1","a1",1), true);
}

TEST(TestGroup, Livre_egalite_2) 
{
